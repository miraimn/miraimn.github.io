...
void main(){
  ...
  // gl_Position = projectionMatrix * modelViewMatrix * vec4(position * vec4(position * scale, 1.0));
} 
`;
const _FS = `
void main(){
...
// }
  // gl_FragColor = vec4(0.5,0.6, 0.0, 1.0);
} 
`;
class CharacterControllerDemo {
  ...
  _Initialize() {
    ...
    document.getElementById("myScene").appendChild(this._threejs.domElement);
